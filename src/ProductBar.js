...
function ProductBar() {
  return (
    <Container>
      {/* Product List */}
      <Row className="my-4 justify-content-center gx-4 gy-4">
        <Col xs={6} sm={6} md={4} lg={3} className="d-flex flex-column align-items-center">
          <Product 
